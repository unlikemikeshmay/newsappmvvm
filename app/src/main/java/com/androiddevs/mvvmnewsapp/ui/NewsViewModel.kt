    ...
    private suspend fun safeSearchNewsCall(searchQuery: String){
        ...
        try {
            if(hasInternetConnection()){
                ...
                searchNews.postValue(Resource.Error("No Internet Connection. Please reconnect and try again."))
            }
    ...
    private suspend fun safeBreakingNewsCall(countryCode: String){
        ...
        try {
            if(hasInternetConnection()){
                ...
                breakingNews.postValue(Resource.Error("No Internet Connection. Please reconnect and try again."))
            }
